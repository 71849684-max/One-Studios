/* INBESTIGA Marketing Cloud v17.16.7 · SAKURA MESSAGING · WHATSAPP-STYLE MULTIMEDIA & MESSAGE CONTROL V2 */
(()=>{
  "use strict";
  const VERSION="v17.16.7",NAME="SAKURA MESSAGING · WHATSAPP-STYLE MULTIMEDIA & MESSAGE CONTROL V2",MODULE="release-marker-v17-16-7";
  ...
  try{window.INBESTIGA_QUALITY_CORE?.register?.(MODULE,{version:VERSION,mode:"sakura-whatsapp-multimedia-v2",polling:false,realtimeChannels:1,mutationObservers:0,backendChanges:true})}catch{}
})();
